...
class MoreExtraPriceScreen extends StatefulWidget {
  const MoreExtraPriceScreen({super.key});

  @override
  State<MoreExtraPriceScreen> createState() => _MoreExtraPriceScreenState();
}

class _MoreExtraPriceScreenState extends State<MoreExtraPriceScreen> {
  @override
  Widget build(BuildContext context) {
    ...
    void createExtracost(ExtracostController extracostController) {
      extracostController
          .createExtracost(
              extraController.text, int.parse(moneyController.text))
          .then((value) {
        if (value['status']) {
          AwesomeDialog(
            context: context,
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        image: const AssetImage('assets/images/phatsinh.jpg'),
                        fit: BoxFit.cover,
                  ...
                  const BigText(
                    text: 'Tên phí phát sinh',
                  ),
                  SizedBox(
                    height: Dimensions.heightPadding20,
                  ),
                  TextFieldCustom(
                      hint: 'Tên phí phát sinh',
